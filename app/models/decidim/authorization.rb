...
module Decidim
  ...
  class Authorization < ApplicationRecord
    ...
    #
    # Ignore :metadata attribute encryption in favor of our customized encryptor
    # see: lib/extends/verifications_omniauth/decidim-core/app/models/decidim/authorization.rb
    #
